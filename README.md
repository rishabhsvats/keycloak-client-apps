...
| **full-app-stack**    | Stack    | -    | Composite application workspace for running a full Keycloak-integrated stack |
...
**full-app-stack** — Workspace for end-to-end stack development and orchestration in this repository.
